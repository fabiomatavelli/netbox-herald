...
*/}}
{{- define "netbox-herald.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "netbox-herald.resourceName" -}}
{{- $fullname := include "netbox-herald.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "netbox-herald.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "netbox-herald.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
